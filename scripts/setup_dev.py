...
def main() -> None:
    ...
    print(f"[INFO] Installing drake-models[dev] in editable mode...")
    ...
    subprocess.run([sys.executable, "-m", "pip", "install", "-e", str(VENDOR_UD_TOOLS)], cwd=PROJECT_ROOT, check=True)
